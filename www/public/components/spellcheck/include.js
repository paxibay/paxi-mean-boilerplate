...
if (typeof(livespell) == "undefined") {
    var livespell = {
        ...
        test: {
            ...
            isword: function(str) {
                ...
                str = str.replace(/&nbsp;/g, " ")
                return (/^([\w'’\u2018\u2019`íë\x81-\xA7\xC0-\xFF]+)$$/i).test(str);
            },
    ...
    livespell.insitu = {
        ...
        hasChanged: function(id) {
            var neue = E$(id).value.replace(/\t/gi, " ").replace(/\x0D\x0A/g, String.fromCharCode(10));
            var old = livespell.insitu.getProxyText(id).replace(/\x0D\x0A/g, String.fromCharCode(10));
            return neue != old;
        },
